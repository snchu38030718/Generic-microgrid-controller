# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 17:53:21 2019
...
### Call dispatch###
    ...
    #griddisp(Pwind,Pload,SoC,PES,start_ds,Type,Disp_mode,SoC_ref)
        Gdisp=Griddisp2.Griddisp2()
        Gdisp.griddisp2(Prer,Pload,SoC,PES,start_ds,Type,Disp_mode,SoC_ref) 
        Pcurt=Gdisp.Prerref
        PSLd=Gdisp.Pldref
    ...
    # islanded dispatch
        Idisp=Isldisp2.Isldisp2()
        Idisp.Isldispatch2(Prer,Pload,SoC,start_ds,Type,Disp_mode,SoC_ref)
        Pcurt=Idisp.Prerref
        PSLd=Idisp.Pldref
