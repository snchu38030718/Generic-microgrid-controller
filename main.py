...
SoC1=0.905   ###0.9
flag2=1
StDS=1  ### 0 is SoC1>0.9, otherwise 1
while 1:
...
#         if (SoC1<0.2 and output>0) or (SoC1>0.9 and output<0):   ## force to zero
#            command[3]=0
         command[0]=save00
         command[1]=save11
         command[2]=save22
...
################################################################################       
 # Unplanned islanding 
     if spent_time>130.02 and spent_time<130.04 and tie_flag==0:  # change power reference, considering delay 20ms
         if flag2==1:
